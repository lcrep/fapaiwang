	...
	<view>
		<view class="title-contents">
			...
			<view class="_top titles">
				...
				<view class="topViewText">编辑公告</view>
			</view>
		</view>
		<view class="recordAddCont">
			...
			<view class="recordAddItem">
				...
				<textarea class="recordAddTextArea" auto-height @blur="bindTextAreaBlur1" placeholder="请输入内容 (50字以内)" maxlength="50" placeholder-style="font-size:30rpx;color:#cecece" v-model="title" />
			</view>
			<view class="recordAddItem">
				<view class="recordAddItemHead">
					开始时间:
			...
			<view class="recordAddItem">
				...
				<textarea class="recordAddTextArea" @blur="bindTextAreaBlur2" placeholder="请输入内容 (500字以内)" maxlength="500" placeholder-style="font-size:30rpx;color:#cecece" v-model="content" />
			</view>
	...
	export default {
		...
		methods: {
			...
			subAdd(){
				...
				that.$api.noticeUpdate(param).then(res => {
					if (res.success) {
						uni.showToast({
							title:"发布成功"
						})
