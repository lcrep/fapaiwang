...
var _list = _interopRequireDefault(__webpack_require__(/*! ./pages/my/manageNavs/vacate/list.vue */ 381));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _list_vue_vue_type_template_id_2a0d91ee___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list.vue?vue&type=template&id=2a0d91ee& */ 382);
...
var _default =
{
  ...
  methods: {
    getList: function getList(startPage) {
      ...
      that.$api.retreatList(param).then(function (res) {
        if (res.success) {
