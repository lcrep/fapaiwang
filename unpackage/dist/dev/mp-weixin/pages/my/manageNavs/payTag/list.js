...
var _list = _interopRequireDefault(__webpack_require__(/*! ./pages/my/manageNavs/payTag/list.vue */ 301));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _list_vue_vue_type_template_id_72a8fe9e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list.vue?vue&type=template&id=72a8fe9e& */ 302);
...
var _default =
{
  ...
  methods: {
    getList: function getList(startPage) {
      ...
      that.$api.housepayList(param).then(function (res) {
        if (res.success) {
