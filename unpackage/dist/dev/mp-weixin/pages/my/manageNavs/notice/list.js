...
var _list = _interopRequireDefault(__webpack_require__(/*! ./pages/my/manageNavs/notice/list.vue */ 413));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _list_vue_vue_type_template_id_b160b32a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list.vue?vue&type=template&id=b160b32a& */ 414);
...
/* harmony import */ var _list_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./list.vue?vue&type=style&index=0&lang=css& */ 418);
...
var _default =
{
  ...
  methods: {
    ...
    getList: function getList(startPage) {
      ...
      that.$api.noticeListB(param).then(function (res) {
        if (res.success) {
    ...
    delNotice: function delNotice(id, index) {
      var that = this;
      uni.showModal({
        content: "确定要删除公告吗？",
        confirmText: "确认删除",
        ...
        success: function success(res) {
          if (res.confirm) {
            ...
            that.$api.noticeDelete(param).then(function (res) {
              if (res.success) {
    ...
    editNotice: function editNotice(id) {
      var that = this;
      that.$Router.push({
