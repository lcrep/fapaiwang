...
var _list = _interopRequireDefault(__webpack_require__(/*! ./pages/my/manageNavs/hasJoin/list.vue */ 349));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _list_vue_vue_type_template_id_2458d43a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list.vue?vue&type=template&id=2458d43a& */ 350);
...
var _default =
{
  ...
  methods: {
    getList: function getList(startPage) {
      ...
      that.$api.auctionList(param).then(function (res) {
        if (res.success) {
