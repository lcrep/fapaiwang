...
var _list = _interopRequireDefault(__webpack_require__(/*! ./pages/my/manageNavs/inquire/list.vue */ 317));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _list_vue_vue_type_template_id_231bcbf4___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list.vue?vue&type=template&id=231bcbf4& */ 318);
...
var _default =
{
  ...
  methods: {
    getList: function getList(startPage) {
      ...
      that.$api.diligenceList(param).then(function (res) {
        if (res.success) {
