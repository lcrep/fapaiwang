...
var _list = _interopRequireDefault(__webpack_require__(/*! ./pages/my/manageNavs/contract/list.vue */ 276));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _list_vue_vue_type_template_id_9e9d641e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list.vue?vue&type=template&id=9e9d641e& */ 277);
...

{
  ...
  methods: {
    ...
    getList: function getList(startPage) {
      ...
      that.$api.contractList(param).then(function (res) {
        if (res.success) {
